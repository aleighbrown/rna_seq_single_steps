...
# (1) necessary: the parents dirctory where all the salmon files folder locate + metadata that has sample_name column containing the name of each salmon folder.
# (2) necessary: metadata sheet containing information about the files you're going to compare
# (3) necassary: TX2Gene File for the same GTF that was aligned to salmon
...
metadata_filepath = opt$metadata
tx2gene = opt$tx2gene
...
#TODO add a check to see if there's any that should be filtered
metadata = metadata %>%  
